...
static assert(0, "lv_roller: lv_ddlist is required. Enable it in lv_conf.h (LV_USE_DDLIST  1) ");
}

public import ...lv_core.lv_obj;
public import lv_ddlist;
...
alias lv_roller_mode_t = ubyte;



/*Data of roller*/
struct _Lv_roller_ext_t {
    lv_ddlist_ext_t ddlist; /*Ext. of ancestor*/
    /*New data for this type */
    lv_roller_mode_t mode;/*: 1 !!*/
}alias lv_roller_ext_t = _Lv_roller_ext_t;

enum {
    LV_ROLLER_STYLE_BG,
    LV_ROLLER_STYLE_SEL,
};
alias lv_roller_style_t = ubyte;
 ...
 */
void lv_roller_set_align(lv_obj_t* roller, lv_label_align_t align_);
 ...
 */
void lv_roller_set_selected(lv_obj_t* roller, ushort sel_opt, lv_anim_enable_t anim);
 ...
 */
void lv_roller_set_visible_row_count(lv_obj_t* roller, ubyte row_cnt);
 ...
 */
pragma(inline, true) private void lv_roller_set_fix_width(lv_obj_t* roller, lv_coord_t w) {
 ...
 */
pragma(inline, true) private void lv_roller_set_anim_time(lv_obj_t* roller, ushort anim_time) {
 ...
 */
ushort lv_roller_get_selected(const(lv_obj_t)* roller);
 ...
 */
pragma(inline, true) private void lv_roller_get_selected_str(const(lv_obj_t)* roller, char* buf, ushort buf_size) {
 ...
 */
pragma(inline, true) private const(char)* lv_roller_get_options(const(lv_obj_t)* roller) {
 ...
 */
pragma(inline, true) private ushort lv_roller_get_anim_time(const(lv_obj_t)* roller) {
