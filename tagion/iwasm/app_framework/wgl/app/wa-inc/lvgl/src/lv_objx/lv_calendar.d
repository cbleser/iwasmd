 ...
 */
struct _Lv_calendar_date_t {
    ushort year;
    byte month;
    byte day;
}alias lv_calendar_date_t = _Lv_calendar_date_t;

/*Data of calendar*/
struct _Lv_calendar_ext_t {
    ...
    ubyte highlighted_dates_num;          /*Number of elements in `highlighted_days`*/
    byte btn_pressing;                    /*-1: prev month pressing, +1 next month pressing on the header*/
...
}alias lv_calendar_ext_t = _Lv_calendar_ext_t;
...
alias lv_calendar_style_t = ubyte;
 ...
 */
void lv_calendar_set_highlighted_dates(lv_obj_t* calendar, lv_calendar_date_t* highlighted, ushort date_num);
 ...
 */
ushort lv_calendar_get_highlighted_dates_num(const(lv_obj_t)* calendar);
