...
alias lv_key_t = ubyte;

static if (LV_USE_GROUP != 0) {
/**********************
 *      TYPEDEFS
 **********************/
struct _lv_group_t;;

alias lv_group_style_mod_cb_t = void function(_lv_group_t*, lv_style_t*);
alias lv_group_focus_cb_t = void function(_lv_group_t*);
...
static if (LV_USE_USER_DATA) {
    ...
    ubyte frozen;/*: 1 !!*/         /**< 1: can't focus to new object*/
    ubyte editing;/*: 1 !!*/        /**< 1: Edit mode, 0: Navigate mode*/
    ubyte click_focus;/*: 1 !!*/    /**< 1: If an object in a group is clicked by an indev then it will be
                                   focused */
    ubyte refocus_policy;/*: 1 !!*/ /**< 1: Focus prev if focused on deletion. 0: Focus next if focused on
                                   deletion.*/
    ubyte wrap;/*: 1 !!*/           /**< 1: Focus next/prev can wrap at end of list. 0: Focus next/prev stops at end
                                   of list.*/
}alias lv_group_t = _lv_group_t;

enum { LV_GROUP_REFOCUS_POLICY_NEXT = 0, LV_GROUP_REFOCUS_POLICY_PREV = 1 };
alias lv_group_refocus_policy_t = ubyte;
 ...
 */
lv_res_t lv_group_send_data(lv_group_t* group, uint c);
