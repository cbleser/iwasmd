...
static assert(0, "lv_mbox: lv_cont is required. Enable it in lv_conf.h (LV_USE_CONT  1) ");
}

static if (LV_USE_BTNM == 0) {
static assert(0, "lv_mbox: lv_btnm is required. Enable it in lv_conf.h (LV_USE_BTNM  1) ");
}

static if (LV_USE_LABEL == 0) {
static assert(0, "lv_mbox: lv_label is required. Enable it in lv_conf.h (LV_USE_LABEL  1) ");
}

public import ...lv_core.lv_obj;
public import lv_cont;
public import lv_btnm;
...
/*Data of message box*/
struct _Lv_mbox_ext_t {
    lv_cont_ext_t bg; /*Ext. of ancestor*/
    /*New data for this type */
    lv_obj_t* text; /*Text of the message box*/
    lv_obj_t* btnm; /*Button matrix for the buttons*/
static if (LV_USE_ANIMATION) {
    ushort anim_time; /*Duration of close animation [ms] (0: no animation)*/
}
}alias lv_mbox_ext_t = _Lv_mbox_ext_t;
 ...
 */
void lv_mbox_set_anim_time(lv_obj_t* mbox, ushort anim_time);
 ...
 */
void lv_mbox_start_auto_close(lv_obj_t* mbox, ushort delay);
 ...
 */
ushort lv_mbox_get_active_btn(lv_obj_t* mbox);
 ...
 */
ushort lv_mbox_get_anim_time(const(lv_obj_t)* mbox);
