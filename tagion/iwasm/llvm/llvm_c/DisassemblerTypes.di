 ...
 */
alias LLVMOpInfoCallback = int function (
    void* DisInfo,
    ulong PC,
    ulong Offset,
    ulong Size,
 ...
 * to NULL.
 */
alias LLVMSymbolLookupCallback = const(char)* function (
    void* DisInfo,
    ulong ReferenceValue,
    ulong* ReferenceType,
    ulong ReferencePC,
    const(char*)* ReferenceName);
enum LLVMDisassembler_VariantKind_None = 0;
enum LLVMDisassembler_VariantKind_ARM_HI16 = 1;
enum LLVMDisassembler_VariantKind_ARM_LO16 = 2;
enum LLVMDisassembler_VariantKind_ARM64_PAGE = 1;
enum LLVMDisassembler_VariantKind_ARM64_PAGEOFF = 2;
enum LLVMDisassembler_VariantKind_ARM64_GOTPAGE = 3;
enum LLVMDisassembler_VariantKind_ARM64_GOTPAGEOFF = 4;
enum LLVMDisassembler_VariantKind_ARM64_TLVP = 5;
enum LLVMDisassembler_VariantKind_ARM64_TLVOFF = 6;
/**
