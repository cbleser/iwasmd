 ...
 */
alias LLVMOrcJITTargetAddress = c_ulong;

/**
 * Represents an address in the executor process.
 */
alias LLVMOrcExecutorAddress = c_ulong;
 ...
 */
alias LLVMOrcCSymbolMapPairs = LLVMJITCSymbolMapPair*;
 ...
 */
alias LLVMOrcCAPIDefinitionGeneratorTryToGenerateFunction = LLVMOpaqueError* function (
 ...
 */
alias LLVMOrcSymbolPredicate = int function (
    void* Ctx,
 ...
 */
alias LLVMOrcGenericIRModuleOperationFunction = LLVMOpaqueError* function (
    void* Ctx,
    LLVMModuleRef M);
 ...
 * layer.
 */
alias LLVMOrcIRTransformLayerTransformFunction = LLVMOpaqueError* function (
    void* Ctx,
 ...
 */
alias LLVMOrcObjectTransformLayerTransformFunction = LLVMOpaqueError* function (
    void* Ctx,
 ...
 */
LLVMOrcSymbolStringPoolRef LLVMOrcExecutionSessionGetSymbolStringPool (
    LLVMOrcExecutionSessionRef ES);
 ...
 */
LLVMOrcSymbolStringPoolEntryRef LLVMOrcExecutionSessionIntern (
    LLVMOrcExecutionSessionRef ES,
    const(char)* Name);
 ...
 */
void LLVMOrcResourceTrackerTransferTo (
 ...
 */
LLVMOrcExecutionSessionRef LLVMOrcMaterializationResponsibilityGetExecutionSession (
    LLVMOrcMaterializationResponsibilityRef MR);
 ...
 */
LLVMOrcSymbolStringPoolEntryRef LLVMOrcMaterializationResponsibilityGetInitializerSymbol (
    LLVMOrcMaterializationResponsibilityRef MR);
 ...
 */
LLVMOrcJITDylibRef LLVMOrcExecutionSessionCreateBareJITDylib (
    LLVMOrcExecutionSessionRef ES,
    const(char)* Name);
 ...
 */
LLVMErrorRef LLVMOrcExecutionSessionCreateJITDylib (
    LLVMOrcExecutionSessionRef ES,
 ...
 * exists.
 */
LLVMOrcJITDylibRef LLVMOrcExecutionSessionGetJITDylibByName (
    LLVMOrcExecutionSessionRef ES,
    const(char)* Name);
 ...
 */
LLVMContextRef LLVMOrcThreadSafeContextGetContext (
 ...
 */
LLVMErrorRef LLVMOrcThreadSafeModuleWithModuleDo (
 ...
 * LLVMOrcDisposeJITTargetMachineBuilder.
 */
LLVMOrcJITTargetMachineBuilderRef LLVMOrcJITTargetMachineBuilderCreateFromTargetMachine (
 ...
 */
LLVMErrorRef LLVMOrcObjectLayerAddObjectFile (
 ...
 * ResourceTracker RT.
 */
LLVMErrorRef LLVMOrcObjectLayerAddObjectFileWithRT (
    LLVMOrcObjectLayerRef ObjLayer,
...
void LLVMOrcIRTransformLayerEmit (
 ...
 */
LLVMOrcDumpObjectsRef LLVMOrcCreateDumpObjects (
    const(char)* DumpDir,
 ...
 */
LLVMErrorRef LLVMOrcDumpObjects_CallOperator (
