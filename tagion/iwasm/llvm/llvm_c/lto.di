 ...
 * \since prior to LTO_API_VERSION=3
 */
lto_bool_t lto_module_is_object_file_for_target (
    const(char)* path,
 ...
 * \since prior to LTO_API_VERSION=3
 */
lto_bool_t lto_module_is_object_file_in_memory (
    const(void)* mem,
    size_t length);
 ...
 */
lto_module_t lto_module_create_in_local_context (
    const(void)* mem,
    size_t length,
    const(char)* path);
 ...
 * \since LTO_API_VERSION=11
 */
lto_module_t lto_module_create_in_codegen_context (
    const(void)* mem,
    size_t length,
    const(char)* path,
    lto_code_gen_t cg);
 ...
 */
lto_module_t lto_module_create_from_fd (
    int fd,
    const(char)* path,
    size_t file_size);
 ...
 * \since LTO_API_VERSION=5
 */
lto_module_t lto_module_create_from_fd_at_offset (
    int fd,
    const(char)* path,
    size_t file_size,
    size_t map_size,
 ...
 * \since prior to LTO_API_VERSION=3
 */
lto_symbol_attributes lto_module_get_symbol_attribute (
    lto_module_t mod,
    uint index);
 ...
 * \since LTO_API_VERSION=7
 */
void lto_codegen_set_diagnostic_handler (
    lto_code_gen_t,
 ...
 * \since LTO_API_VERSION=4
 */
void lto_codegen_set_assembler_args (
    lto_code_gen_t cg,
    const(char*)* args,
    int nargs);
 ...
 * \since prior to LTO_API_VERSION=3
 */
void lto_codegen_add_must_preserve_symbol (
    lto_code_gen_t cg,
    const(char)* symbol);
 ...
 * \since LTO_API_VERSION=5
 */
lto_bool_t lto_codegen_write_merged_modules (
    lto_code_gen_t cg,
    const(char)* path);
 ...
 */
void lto_set_debug_options (const(char*)* options, int number);
 ...
 */
void lto_codegen_debug_options_array (
    lto_code_gen_t cg,
    const(char*)*,
    int number);
 ...
 */
void lto_codegen_set_should_internalize (
    lto_code_gen_t cg,
 ...
 * \since LTO_API_VERSION=18
 */
void thinlto_codegen_add_module (
 ...
 * \since LTO_API_VERSION=18
 */
lto_bool_t thinlto_codegen_set_pic_model (
    thinlto_code_gen_t cg,
    lto_codegen_model);
 ...
 * \since LTO_API_VERSION=21
 */
void thinlto_set_generated_objects_dir (
    thinlto_code_gen_t cg,
    const(char)* save_temps_dir);
 ...
 * \since LTO_API_VERSION=19
 */
void thinlto_codegen_set_codegen_only (
    thinlto_code_gen_t cg,
 ...
 * \since LTO_API_VERSION=18
 */
void thinlto_codegen_add_must_preserve_symbol (
    thinlto_code_gen_t cg,
    const(char)* name,
    int length);
 ...
 * \since LTO_API_VERSION=18
 */
void thinlto_codegen_set_cache_dir (
    thinlto_code_gen_t cg,
 ...
 * \since LTO_API_VERSION=18
 */
void thinlto_codegen_set_cache_entry_expiration (
    thinlto_code_gen_t cg,
    uint expiration);
