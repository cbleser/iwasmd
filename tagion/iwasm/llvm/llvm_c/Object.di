...
enum LLVMBinaryType
{
    LLVMBinaryTypeArchive = 0, /**< Archive file. */
    LLVMBinaryTypeMachOUniversalBinary = 1, /**< Mach-O Universal Binary file. */
    LLVMBinaryTypeCOFFImportFile = 2, /**< COFF Import file. */
    LLVMBinaryTypeIR = 3, /**< LLVM IR. */
    LLVMBinaryTypeWinRes = 4, /**< Windows resource (.res) file. */
    LLVMBinaryTypeCOFF = 5, /**< COFF Object file. */
    LLVMBinaryTypeELF32L = 6, /**< ELF 32-bit, little endian. */
    LLVMBinaryTypeELF32B = 7, /**< ELF 32-bit, big endian. */
    LLVMBinaryTypeELF64L = 8, /**< ELF 64-bit, little endian. */
    LLVMBinaryTypeELF64B = 9, /**< ELF 64-bit, big endian. */
    LLVMBinaryTypeMachO32L = 10, /**< MachO 32-bit, little endian. */
    LLVMBinaryTypeMachO32B = 11, /**< MachO 32-bit, big endian. */
    LLVMBinaryTypeMachO64L = 12, /**< MachO 64-bit, little endian. */
    LLVMBinaryTypeMachO64B = 13, /**< MachO 64-bit, big endian. */
    LLVMBinaryTypeWasm = 14 /**< Web Assembly. */
}
 ...
 */
LLVMBinaryRef LLVMMachOUniversalBinaryCopyObjectForArch (
    LLVMBinaryRef BR,
    const(char)* Arch,
    size_t ArchLen,
    char** ErrorMessage);
 ...
 */
LLVMBool LLVMObjectFileIsSymbolIteratorAtEnd (
    LLVMBinaryRef BR,
