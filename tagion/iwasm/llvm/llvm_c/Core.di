...
{
    LLVMNoUnnamedAddr = 0, /**< Address of the GV is significant. */
    LLVMLocalUnnamedAddr = 1, /**< Address of the GV is locally insignificant. */
    LLVMGlobalUnnamedAddr = 2 /**< Address of the GV is globally insignificant. */
}
...
enum LLVMLandingPadClauseTy
{
    ...
    LLVMLandingPadFilter = 1 /**< A filter clause  */
}
...
enum LLVMAtomicRMWBinOp
{
    ...
    LLVMAtomicRMWBinOpUMin = 10, /**< Sets the value if it's greater than the
      original using an unsigned comparison and return
      the old one */
    LLVMAtomicRMWBinOpFAdd = 11, /**< Add a floating point value and return the
      old one */
    LLVMAtomicRMWBinOpFSub = 12 /**< Subtract a floating point value and return the
      old one */
}
 ...
 */
LLVMModuleFlagBehavior LLVMModuleFlagEntriesGetFlagBehavior (
 ...
 */
LLVMValueMetadataEntry* LLVMGlobalCopyAllMetadata (
    LLVMValueRef Value,
    size_t* NumEntries);
 ...
 */
uint LLVMValueMetadataEntriesGetKind (
 ...
 */
LLVMValueMetadataEntry* LLVMInstructionGetAllMetadataOtherThanDebugLoc (
    LLVMValueRef Instr,
    size_t* NumEntries);
