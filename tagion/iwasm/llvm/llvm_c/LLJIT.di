 ...
 */
alias LLVMOrcLLJITBuilderObjectLinkingLayerCreatorFunction = LLVMOrcOpaqueObjectLayer* function (
    void* Ctx,
 ...
 * RT.
 */
LLVMErrorRef LLVMOrcLLJITAddObjectFileWithRT (
    LLVMOrcLLJITRef J,
 ...
 * RT.
 */
LLVMErrorRef LLVMOrcLLJITAddLLVMIRModuleWithRT (
    LLVMOrcLLJITRef J,
 ...
 * Returns a non-owning reference to the LLJIT instance's object linking layer.
 */
LLVMOrcObjectTransformLayerRef LLVMOrcLLJITGetObjTransformLayer (
    LLVMOrcLLJITRef J);
