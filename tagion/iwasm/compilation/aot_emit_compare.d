...
private bool float_cond_to_llvm_op(FloatCond cond, LLVMRealPredicate* op) {
...
bool aot_compile_op_i32_compare(AOTCompContext* comp_ctx, AOTFuncContext* func_ctx, IntCond cond) {
    ...
    LLVMValueRef lhs = void, rhs = void, res = void;
    ...
    if (((res = LLVMBuildICmp(comp_ctx.builder, op, lhs, rhs, "i32_cmp")) == 0)) {
...
bool aot_compile_op_i64_compare(AOTCompContext* comp_ctx, AOTFuncContext* func_ctx, IntCond cond) {
    ...
    if (((res = LLVMBuildICmp(comp_ctx.builder, op, lhs, rhs, "i64_cmp")) == 0)) {
        aot_set_last_error("llvm build compare failed.");
        return false;
    }
...
bool aot_compile_op_f32_compare(AOTCompContext* comp_ctx, AOTFuncContext* func_ctx, FloatCond cond) {
    ...
    if (comp_ctx.disable_llvm_intrinsics
        ...
        res = aot_call_llvm_intrinsic(comp_ctx, func_ctx, "f32_cmp", I32_TYPE,
                                      param_types.ptr, 3, opcond, lhs, rhs);
        if (!res) {
            goto fail;
        }
