...
void invokeNative(void function() native_code, uint* argv, uint argc) {
    bh_assert(argc >= (WASMExecEnv*).sizeof / uint32.sizeof);
    ...
    switch (argc) {
        ...
        default:
        {
            ...
            WASMExecEnv* exec_env = *cast(WASMExecEnv**)argv;
