...
/* Thread data key */
private aos_task_key_t thread_data_key;
...
private void os_thread_cleanup() {
    ...
    aos_mutex_t* wait_list_lock = void;
    aos_sem_t* wait_node_sem = void;
...
int os_thread_create_with_prio(korp_tid* p_tid, thread_start_routine_t start, void* arg, uint stack_size, int prio) {
    ...
    /* Create the thread */
    if (aos_task_new_ext(cast(aos_task_t*)thread_data, thread_name.ptr,
...
korp_tid os_self_thread() {
    return cast(korp_tid)aos_task_getspecific(thread_data_key);
}
...
private int os_cond_wait_internal(korp_cond* cond, korp_mutex* mutex, bool timed, uint mills) {
