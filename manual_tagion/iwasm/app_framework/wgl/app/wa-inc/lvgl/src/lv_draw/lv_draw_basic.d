 ...
 */
void lv_draw_letter(const(lv_point_t)* pos_p, const(lv_area_t)* mask_p, const(lv_font_t)* font_p, uint letter, lv_color_t color, lv_opa_t opa);
 ...
 */
void lv_draw_map(const(lv_area_t)* cords_p, const(lv_area_t)* mask_p, const(ubyte)* map_p, lv_opa_t opa, bool chroma_key, bool alpha_byte, lv_color_t recolor, lv_opa_t recolor_opa);
