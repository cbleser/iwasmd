 ...
 *      DEFINES
 *********************/
enum LV_TXT_COLOR_CMD = "#";

enum LV_TXT_ENC_UTF8 = 1;
enum LV_TXT_ENC_ASCII = 2;
...
alias lv_txt_cmd_state_t = ubyte;
 ...
 * they are different)
 */
ushort lv_txt_get_next_line(const(char)* txt, const(lv_font_t)* font, lv_coord_t letter_space, lv_coord_t max_width, lv_txt_flag_t flag);
 ...
 */
lv_coord_t lv_txt_get_width(const(char)* txt, ushort length, const(lv_font_t)* font, lv_coord_t letter_space, lv_txt_flag_t flag);
 ...
 */
bool lv_txt_is_cmd(lv_txt_cmd_state_t* state, uint c);
 ...
 */
void lv_txt_ins(char* txt_buf, uint pos, const(char)* ins_txt);
 ...
 */
void lv_txt_cut(char* txt, uint pos, uint len);
 ...
 */
extern ubyte function(const(char)*) lv_txt_encoded_size;
 ...
 */
extern uint function(uint) lv_txt_unicode_to_encoded;
 ...
 */
extern uint function(uint c) lv_txt_encoded_conv_wc;
 ...
 */
extern uint function(const(char)*, uint*) lv_txt_encoded_next;
 ...
 */
extern uint function(const(char)*, uint*) lv_txt_encoded_prev;
 ...
 */
extern uint function(const(char)*, uint) lv_txt_encoded_get_byte_id;
 ...
 */
extern uint function(const(char)*, uint) lv_encoded_get_char_id;
 ...
 */
extern uint function(const(char)*) lv_txt_get_encoded_length;
