...
static assert(0, "lv_tabview: lv_btnm is required. Enable it in lv_conf.h (LV_USE_BTNM  1) ");
}

static if (LV_USE_PAGE == 0) {
static assert(0, "lv_tabview: lv_page is required. Enable it in lv_conf.h (LV_USE_PAGE  1) ");
}

public import ...lv_core.lv_obj;
public import ...lv_objx.lv_win;
...
alias lv_tabview_btns_pos_t = ubyte;

/*Data of tab*/
struct _Lv_tabview_ext_t {
    /*Ext. of ancestor*/
...
static if (LV_USE_ANIMATION) {
    ...
    ubyte slide_enable;/*: 1 !!*/ /*1: enable horizontal sliding by touch pad*/
    ubyte draging;/*: 1 !!*/
    ubyte drag_hor;/*: 1 !!*/
    ubyte scroll_ver;/*: 1 !!*/
    ubyte btns_hide;/*: 1 !!*/
    lv_tabview_btns_pos_t btns_pos;/*: 2 !!*/
}alias lv_tabview_ext_t = _Lv_tabview_ext_t;
...
alias lv_tabview_style_t = ubyte;
 ...
 */
void lv_tabview_set_tab_act(lv_obj_t* tabview, ushort id, lv_anim_enable_t anim);
 ...
 */
void lv_tabview_set_anim_time(lv_obj_t* tabview, ushort anim_time);
 ...
 */
ushort lv_tabview_get_tab_act(const(lv_obj_t)* tabview);
 ...
 * @return tab count
 */
ushort lv_tabview_get_tab_count(const(lv_obj_t)* tabview);
/**
 ...
 */
lv_obj_t* lv_tabview_get_tab(const(lv_obj_t)* tabview, ushort id);
 ...
 */
ushort lv_tabview_get_anim_time(const(lv_obj_t)* tabview);
